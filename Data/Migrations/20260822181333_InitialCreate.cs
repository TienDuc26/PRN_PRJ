        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeInfo = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookedGuests = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GuideAssignments_TourSchedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "TourSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuideAssignments_GuideId_ScheduleId",
                table: "GuideAssignments",
                columns: new[] { "GuideId", "ScheduleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GuideAssignments_ScheduleId",
                table: "GuideAssignments",
                column: "ScheduleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourSchedules_Code",
                table: "TourSchedules",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TourSchedules_StartDate",
                table: "TourSchedules",
                column: "StartDate");
